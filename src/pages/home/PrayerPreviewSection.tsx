...
export default function PrayerPreviewSection() {
  const [prayers, setPrayers] = useState<PrayerRequest[]>(demoPrayers.slice(0, 4));
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setPrayers((prev) => [newPrayer, ...prev.slice(0, 3)]);
            ...
            <div className="bg-[#f5f0e8] rounded-2xl p-6 lg:sticky lg:top-24">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  />
                  <p className="text-xs text-[#6b7c93] mt-1 text-right">
